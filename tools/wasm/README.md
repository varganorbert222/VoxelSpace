...
The product kernels are `classic_columns`, `frustum_scanline_columns`, `pano_columns`, and `pano_view_columns`. Do not `fetch("*.wasm")`. Do not enable WASM SIMD as the product module.
